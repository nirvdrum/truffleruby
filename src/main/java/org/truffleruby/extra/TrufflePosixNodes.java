...
public abstract class TrufflePosixNodes {
    ...
    public abstract static class InvalidateEnvNode extends PrimitiveArrayArgumentsNode {
        ...
        /** The name is compared as bytes rather than converted to a Java String, since a variable name may hold
         * non-ASCII bytes in the BINARY encoding, which have no Java String representation. */
        @TruffleBoundary
