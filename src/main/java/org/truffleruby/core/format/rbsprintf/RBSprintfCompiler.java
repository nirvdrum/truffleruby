...
public class RBSprintfCompiler {
    ...
    public Object typeList(Object format, RubyStringLibrary libFormat, TruffleString.GetInternalByteArrayNode byteArrayNode,  RubyContext context, RubyLanguage language) {
        var formatTString = libFormat.getTString(format);
