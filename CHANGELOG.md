...
* The TruffleRuby version changed from being based on the GraalVM version to being based on the CRuby version. TruffleRuby version `AB.C.D` aims to be compatible with CRuby `A.B`. See [the README](README.md#releases) for more details (#4020, @eregon).
